...
urlpatterns = [
    ...
    path('responsavel/filhos/', views.responsavel_filhos, name='responsavel_filhos'),
    path('responsavel/mensagens/', views.responsavel_mensagens, name='responsavel_mensagens'),
    path('responsavel/ajuda/', views.responsavel_ajuda, name='responsavel_ajuda'),
